...
export default function Article() {
  ...
  return (
    <SafeAreaView style={tw`flex flex-col bg-red-500`}>
      <View style={tw`absolute right-0 z-10 mr-5 mt-4 top-7`}>
        <FindButton />
      </View>
        ...
        <ScrollView style={tw`mb-16`}>
          <Pressable
            ...
            <Text style={tw`ml-2 w-[90%] text-base pr-2 pb-5`}>
              ...
              la beauté et l'inconcevable immensité du cosmos.Un an après la publication de ses premiers clichés du cosmos, le télescope spatial James Webb a livré ce mercredi une
